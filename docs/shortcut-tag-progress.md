...
- The shipped helper shortcut name is `remindctl - Search By Tag`.
- The canonical repo home for shipped Shortcut assets is `Support/Shortcuts/`.
...
printf '{ "tags": ["active-project"] }' \
  | shortcuts run "remindctl - Search By Tag" \
